...
class ResetPassword extends Component {
  ...
  validateToken = () => {
    fetch(auth.prepareURL(process.env.REACT_APP_API_URL_AUTH_FP_CHECK_TOKEN),
  ...
  onSubmit = (event) => {
    ...
    if(this.isPasswordValid() && this.isPassword2Valid())
    {
        ...
        fetch(auth.prepareURL(process.env.REACT_APP_API_URL_AUTH_RESET_PASSWORD),
              auth.getRequestInit('post',{
                  ...
                  <CCard className="p-6">
                    <CCardBody>
                      <CForm onSubmit={this.onSubmit}>
                        <h1>{t("ResetPassword.titles.reset_password")}</h1>
                        <hr/>
